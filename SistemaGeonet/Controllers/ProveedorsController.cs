...
namespace SistemaGeonet.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idProveedor,nombre,contacto,pais,direccion")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idProveedor,nombre,contacto,pais,direccion")] Proveedor proveedor)
        {
